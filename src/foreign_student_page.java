 ...
 * @author lenovo
 */
public class foreign_student_page extends javax.swing.JFrame {

    /**
     * Creates new form foreign_student_page
     */
    public foreign_student_page() {
        initComponents();
    }

         public void show_Info(String sql)
    {
        foreign_student fs = new foreign_student(null,null,null,null,null,null);
        ArrayList<info_type> list = fs.userList(sql);
    ...
    private void tview1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tview1ActionPerformed
        ...
        foreign_student fs = new foreign_student(null,null,null,null,null,null);
        bview.setText(fs.busineaamaninfo(fb));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(foreign_student_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new foreign_student_page().setVisible(true);
            }
        });
    }
